...
export class ProductsService {
  ...
  async findAll(getProductsDto): Promise<Product[]> {
      ...
      const { sort, limit, category, isFeatured, search, minPrice, maxPrice} = getProductsDto;
      ...
      const featuredQuery = isFeatured ? {isFeatured: true} : {};
      ...
      const query = {...searchQuery, ...categoryQuery, ...priceQuery, ...featuredQuery};
      const option = {
